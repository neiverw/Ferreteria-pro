...
function AppSidebar({ activeView, setActiveView }: { 
  ...
  // Obtener el nombre de la empresa de las configuraciones o usar un valor por defecto
...
function AppMain() {
  ...
  const renderContent = () => {
    ...
    switch (activeView) {
      case 'dashboard':
        return canAccess('dashboard') ? <DashboardOverview /> : null;
      case 'inventory':
        return canAccess('inventory') ? <InventoryDashboard /> : null;
      case 'suppliers':
        return canAccess('suppliers') ? <SuppliersManagement /> : null;
      case 'billing':
        return canAccess('billing') ? <BillingSystem /> : null;
      case 'customers':
        return canAccess('customers') ? <CustomerManagement /> : null;
      case 'reports':
        return canAccess('reports') ? <ReportsSystem /> : null;
      case 'settings':
        return canAccess('settings') ? <SettingsSystem /> : null;
      default:
